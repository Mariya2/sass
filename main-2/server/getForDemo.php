...
$id1= isset($_POST['id1'])?$_POST['id1']: 1;
$id2= isset($_POST['id2'])?$_POST['id2']: 2;
$id3= isset($_POST['id3'])?$_POST['id3']: 3;

$data = [[$id1, $id2, $id3]];
require_once 'db_settings.php';

$pdo = new PDO('mysql:host=localhost;dbname=dbschema', DB_USER, DB_PASS, [
